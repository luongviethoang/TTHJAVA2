    ...
    public static void main(String[] args) {
        try (
            ...
            while (exitBtn != 4){
                ...
                System.out.println("-- 2. to display student records in collection--");
                System.out.println("-- 3. Enter 3 to save student record to database--");
                System.out.println("-- 4. to exit--");
                System.out.println("-- 5. to display student records in database--");
